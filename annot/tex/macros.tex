\newcommand*{\true}{\top} % {\mathSf{tt}}
\newcommand*{\false}{\bot} % {\mathSf{ff}}
...
% Matches.
\newcommand*{\matchHole}[1]{\textcolor{gray}{[}#1\textcolor{gray}{]}}
...
\newcommand*{\matchPlug}[2]{\textcolor{gray}{#1}\matchHole{#2}}
...
\newcommand*{\matchFalse}[2]{\lowlight{\{\exTrue\mapsto{#1},\,}\matchPlug{\exFalse\mapsto\;}{#2}\lowlight{\}}}
\newcommand*{\matchTrue}[2]{\lowlight{\{}\matchPlug{\exTrue\mapsto\;}{#1}\lowlight{,\exFalse\mapsto{#2}\}}}
\newcommand*{\matchNil}[4]{\lowlight{\{}\matchPlug{\exNil\mapsto\;}{#1}\lowlight{,\branchCons{#2}{#3}{#4}\}}}
\newcommand*{\matchCons}[4]{\lowlight{\{\branchNil{#1},\,}\matchPlug{\exCons{#2}{#3}\mapsto\;}{#4}\lowlight{\}}}
