...
\newcommand*{\sExCons}[2]{\kw{\lbrack}\;{#1}\;\cdot\;{#2}\kw{\rbrack}}
\newcommand*{\sExNil}{\kw{\lbrack}\kw{\rbrack}}
\newcommand*{\exList}[1]{\kw{\lbrack}\;{#1}\;\kw{\rbrack}}
\newcommand*{\exListSeq}[2]{\kw{\lbrack}\;{#1}\;\kw{..}\;{#2}\;\kw{\rbrack}}
\newcommand*{\exListComp}[2]{\kw{\lbrack}\;{#1}\;\kw{$\vert$}\;{#2}\;\kw{\rbrack}}
\newcommand*{\exInt}[1]{#1}
...
\newcommand*{\branchEList}[1]{\{\lbrack\rbrack\mapsto{#1}\}}
\newcommand*{\branchNEList}[1]{\{ \lbrack p \cdot p' \rbrack \mapsto{#1}\}  }
...
\newcommand*{\pattCons}[2]{\kw{Cons}(#1,#2)}
\newcommand*{\pattNil}{\kw{Nil}}
\newcommand*{\pattSCons}[2]{\lbrack {#1} \cdot {#2} \rbrack}
\newcommand*{\pattSNil}{\lbrack\rbrack}
...
\newcommand*{\elimSList}[2]{ \{ \sExNil \mapsto {#1}, \sExCons{s}{s'} \ {#2}\}}
...
\newcommand*{\totalise}[2]{\kw{totalise}({#1}, {#2})}
\newcommand*{\untotalise}[2]{\kw{untotalise}({#1}, {#2})}
