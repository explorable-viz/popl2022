...
\newcommand*{\enumFromTo}[2]{\kw{enumFromTo}\;({#1},{#2})}
...
\newcommand*{\trBinaryApp}[3]{\exBinaryApp{#1}{#2}{#3}}
...
% Desugaring.
\newcommand*{\darrow}{\mathrel{\overset{d}{\longrightarrow}}}

% Totalizing.
\newcommand*{\tarrow}{\mathrel{\overset{t}{\longrightarrow}}}