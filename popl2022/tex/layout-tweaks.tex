...
\newcommand*{\codeSel}[1]{\fboxsep=1pt\fcolorbox{yellow!80!black}{yellow!50}{\mystrut#1}}
\newcommand*{\codeSelTwo}[1]{\fboxsep=0pt\fcolorbox{LightGreen}{LightGreen!50}{\mystrut#1}}
\newcommand*{\codeErase}[1]{\fboxsep=1pt\fcolorbox{GainsboroFaded}{GainsboroFaded!50}{\mystrut#1}}
\newcommand*{\codeEraseTwo}[1]{\fboxsep=0pt\fcolorbox{GainsboroDarkened}{GainsboroDarkened!50}{\mystrut#1}}
