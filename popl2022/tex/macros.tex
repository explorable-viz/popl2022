\newcommand*{\OurLanguage}{Fluid\xspace}
...
\newcommand*{\primFwdBool}[2]{\fwdF{{#1}_{\Ann{A}}}{#2}}
\newcommand*{\primBwd}[2]{\bwdF{#1}{#2}}
\newcommand*{\primBwdBool}[2]{\bwdF{{#1}_{\Ann{A}}}{#2}}
...
\newcommand*{\SelF}[1]{\Set{Sel}_{\bm{#1}}}

% Meta-types
\newcommand*{\Bool}{\Ann{2}}%{\mathbb{B}}
\newcommand*{\Unit}{\Ann{1}}
...
%{{\Large \textit{\fontfamily{qzc}\selectfont#1}}}%
\mathscr{#1}
}
\newcommand*{\Ann}[1]{\mathscr{#1}}
\newcommand*{\raw}[1]{\bm{#1}}
\newcommand*{\Lattice}[5]{\langle#1,#1,#2,#3,#4\rangle}
