...
\newcommand*{\closeDefsFwdF}[1]{\fwdF{rec}{#1}}
\newcommand*{\closeDefsBwdF}[1]{\bwdF{rec}{#1}}
\newcommand*{\closeDefsGC}[1]{\GC{rec}{#1}}
...
% Environments.
\newcommand*{\envLookupS}{\mathrel{\filledtriangleright}}
\newcommand*{\envLookupR}{\envLookupS}
\newcommand*{\envLookupBwdS}{\filledtriangleleft}
\newcommand*{\envLookupBwdR}[1]{\mathrel{\sub{\envLookupBwdS}{#1}}}
\newcommand*{\envLookup}[3]{{#1}\envLookupR\bind{#2}{#3}}
...
\newcommand*{\mapUpdate}[3]{{#1}\mathrel{\filledtriangleleft}\bind{#2}{#3}}
...
\newcommand*{\evalFwdF}[1]{\fwdF{eval}{#1}}
\newcommand*{\evalBwdF}[1]{\bwdF{eval}{#1}}
...
\newcommand*{\matchFwdF}[1]{\fwdF{match}{#1}}
\newcommand*{\matchBwdF}[1]{\bwdF{match}{#1}}
\newcommand*{\matchBwdR}[1]{\matchBwdS_{#1}}
\newcommand*{\matchGC}[1]{\GC{match}{#1}}
...
% Traces.
\newcommand*{\trApp}[3]{\exApp{#1}{#2} \mathrel{\filledtriangleright} {#3}}
\newcommand*{\trAppNew}[6]{\exApp{\sub{#1}{#2,#3}}{#4} \mathrel{\filledtriangleright} {\bind{#5}{#6}}}
...
\newcommand*{\trLetRecMutualNew}[3]{\sub{\kw{let}}{#1}\;{#2}\;\kw{in}\;{#3}}
...
\newcommand*{\desugarFwd}{\dfwdarrow}
\newcommand*{\desugarBwd}[1]{\sub{\dbwdarrow}{#1}}
\newcommand*{\desugarFwdF}[1]{\fwdF{dsg}{#1}\hspace{-0.05em}}
\newcommand*{\desugarBwdF}[1]{\bwdF{dsg}{#1}\hspace{-0.11em}}
\newcommand*{\desugarGC}[1]{\GC{dsg}{#1}\hspace{-0.11em}}

\newcommand*{\desugarListRestFwdF}[1]{\fwdF{desug}{#1}}
\newcommand*{\desugarListRestBwdF}[1]{\bwdF{desug}{#1}}

\newcommand*{\desugarClauseFwd}{\desugarFwd}
\newcommand*{\desugarClauseBwd}[1]{\desugarBwd{#1}}
\newcommand*{\desugarClauseFwdF}[1]{\mathsf{desugClauseFwd}_{#1}}
\newcommand*{\desugarClauseBwdF}[1]{\mathsf{desugClauseBwd}_{#1}}
\newcommand*{\desugarClausesFwd}{\desugarFwd}
\newcommand*{\desugarClausesFwdF}[1]{\fwdF{eqns}{#1}}
\newcommand*{\desugarClausesBwdF}[1]{\bwdF{eqns}{#1}}
\newcommand*{\desugarClausesGC}[1]{\GC{eqns}{#1}}

\newcommand*{\clauseFwd}{\mathrel{{\rotatebox[origin=c]{45}{$\rightharpoonup$}}}}
\newcommand*{\clauseBwd}[1]{\sub{\mathrel{{\rotatebox[origin=c]{-45}{$\rightharpoonup$}}}}{#1}}
\newcommand*{\clauseFwdF}[1]{\fwdF{clause}{#1}}
\newcommand*{\clauseBwdF}[1]{\bwdF{clause}{#1}}
\newcommand*{\clauseGC}[1]{\GC{clause}{#1}}

\newcommand*{\totalisefwdarrow}{\nearrow}
\newcommand*{\totalisebwdarrow}{\searrow}
\newcommand*{\totalise}[3]{{#1},{#2} \totalisefwdarrow {#3}}
\newcommand*{\totaliseGeq}[3]{{#1},{#2} \totalisefwdarrow\geq {#3}}
\newcommand*{\totalisebwd}[4]{{#1} \sub{\totalisebwdarrow}{#2} {#3}, {#4}}
\newcommand*{\totaliseFwdF}[1]{\fwdF{totalise}{#1}}
\newcommand*{\totaliseBwdF}[1]{\bwdF{totalise}{#1}}
\newcommand*{\totaliseGC}[1]{\GC{totalise}{#1}}

\newcommand*{\listGenFwd}{\mathrel{R}}
\newcommand*{\listGenBwd}[1]{\mathrel{\sub{S}{#1}}}
\newcommand*{\listGenFwdF}[1]{\mathsf{listGenFwd}_{#1}}
\newcommand*{\listGenBwdF}[1]{\mathsf{listGenBwd}_{#1}}
