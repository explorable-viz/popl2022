...
\newcommand*{\primAppF}[1]{\sub{{_{*}\mathsf{primApp}}}{#1}}
...
\newcommand*{\evalFwdF}[1]{\sub{{_{*}\mathsf{eval}}}{#1}}
...
\newcommand*{\matchFwdF}[1]{\sub{{_{*}\mathsf{match}}}{#1}}
\newcommand*{\matchBwdF}[1]{\sub{{^{*}\mathsf{match}}}{#1}}
...
\newcommand*{\desugarFwdF}[1]{\mathsf{desugFwd}_{#1}}
\newcommand*{\desugarBwdF}[1]{\mathsf{desugBwd}_{#1}}
