...
\newcommand*{\desugarListRestFwdF}[1]{\mathsf{desugListRest}(#1)_*}
\newcommand*{\desugarListRestBwdF}[1]{\mathsf{desugListRest}(#1)^*}

\newcommand*{\desugarClauseFwd}{\desugarFwd}
\newcommand*{\desugarClauseBwd}[1]{\desugarBwd{#1}}
\newcommand*{\desugarClauseFwdF}[1]{\mathsf{desugClause}(#1)_*}
\newcommand*{\desugarClauseBwdF}[1]{\mathsf{desugClause}(#1)^*}
\newcommand*{\desugarClausesFwdF}[1]{\mathsf{desugClauses}(#1)_*}
\newcommand*{\desugarClausesBwdF}[1]{\mathsf{desugClauses}(#1)^*}
...
\newcommand*{\listGenFwd}[1]{\mathrel{\sub{R}{#1}}}
\newcommand*{\listGenBwd}[1]{\mathrel{\sub{S}{#1}}}
\newcommand*{\listGenFwdF}[1]{\mathsf{listGen}(#1)_*}
\newcommand*{\listGenBwdF}[1]{\mathsf{listGen}(#1)^*}
