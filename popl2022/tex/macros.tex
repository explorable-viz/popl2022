...
\newcommand*{\ProofInSupplementaryMaterial}{Included supplementary materials.}
...
\newcommand*{\primFwdBool}[2]{\fwdF{#1}{#2}} % _{\Ann{A}}
\newcommand*{\primBwd}[2]{\bwdF{#1}{#2}}
\newcommand*{\primBwdBool}[2]{\bwdF{#1}{#2}} % _{\Ann{A}}
