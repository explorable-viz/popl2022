\vspace{1mm}
\hshade{\small \flushleft $\explVal{w}{v, \sigma \matchR \rho, \kappa}$%
\hfill \emph{$w$ witnesses that $\sigma$ matches $v$ and yields continuation $\kappa$ under environment $\rho$}}
\begin{smathpar}
