...
}
{
   \Gamma
   \vdash
   \elimRec{\seqEmpty}{\kappa}: \tyFun{\tyRec{\seqEmpty}}{A}
}
%
\and
%
\inferrule*
{
   \Gamma \vdash \elimRec{\vec{y}}{\sigma}: \tyFun{A'}{\tyFun{\tyRec{\vec{\bind{y}{A}}}}{B}}
}
{
   \Gamma
   \vdash
   \elimRec{(x \concat \vec{y})}{\sigma}: \tyFun{\tyRec{(\bind{x}{A'} \concat \vec{\bind{y}{A})}}}{B}
}
%
\and
%
