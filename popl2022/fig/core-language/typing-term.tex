...
%
\inferrule*[right={
   \textnormal{$ \length{ \vec{x}} = n $}
}]
{
   \Gamma \vdash \sigma:  \tyFun{\seqRangeOp{A_1}{A_{n+1}}{\rightarrow}}{B} %\tyFun{\tyRec{\vec{\bind{x}{A}}}}{\tyFun{A'}{B}}
}
{
   \Gamma
   \vdash
   \elimRec{\vec{x}}{\sigma}: \tyFun{\tyRec{\vec{\bind{x}{A}}}}{B}
}
%
\and
%
