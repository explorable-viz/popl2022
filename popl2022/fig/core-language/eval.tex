\hshade{\small \flushleft $\explVal{T}{\rho, e \evalR v}$%
\hfill \textbfit{$T$ witnesses that $e$ evaluates in environment $\rho$ to value $v$}}
\begin{smathpar}
   \inferrule*[
   ...
   {
      \explVal{\trRecProj{T}{\vec{x}}{x_i}}
              {\rho, \exRecProj{e}{x_i} \evalR v_i}
   }
   %
   \and
   %
...
%              {\rho, \exVec{e}{x}{e'} \evalR \exVecVal{\vec{v}}{j}}
%   }
%   %
%   \and
%   %
...
%   ]
%   {
%      \explVal{T}{\rho, e \evalR \exVecVal{\vec{v}}{j}}
%      \\
