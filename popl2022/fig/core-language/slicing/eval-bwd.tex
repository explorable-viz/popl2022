\begin{figure}
   ...
   \begin{smathpar}
      ...
      ]
      {
         ...
         \\
         \rho_2 \closeDefsBwdR \rho_1', h, \alpha'
         \\
         \evalBwd{\annClosure{\rho_1 \join \rho_1'}{h}{\beta}{\sigma}}{T}{\rho'}{e_1}{\alpha^\twoPrime}
      }
      {
         \evalBwd{v}{\trApp{T}{U}{w}{T'}}{\rho \join \rho'}{\exApp{e_1}{e_2}}{\alpha \join \alpha' \join \alpha^\twoPrime}
      }
   \end{smathpar}
   \vspace{1mm}
