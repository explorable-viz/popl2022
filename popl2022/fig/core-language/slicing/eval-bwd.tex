...
\end{minipage}
   ...
   \hfill \textbfit{$\rho$ backward-generates to $\rho'$, $h$ and $\alpha$}}
   \begin{smathpar}
      \inferrule*[
         lab={\ruleName{$\closeDefsBwdR$-rec-defs}}
      ]
      {
         v_i = \annClosure{\alpha_i}{\rho_i}{h_i}{\sigma_i}
         \quad
      ...
      }
      {
         \vec{\bind{x}{v}}
         \closeDefsBwdR
         \bigjoin\vec{\rho}, \vec{\bind{x}{\sigma}} \join {\bigjoin\vec{h}}, \bigjoin{\alpha}
      }
   \end{smathpar}
