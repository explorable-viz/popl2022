...
\end{smathpar}
\caption{Forward data dependency (Boolean cases omitted)}
...
\flushleft \shadebox{$\envLookupBwd{\rho'}{\rho}{\bind{x}{v}}$}
\begin{smathpar}
   \inferrule*[
...
\caption{Backward data dependency (Boolean cases omitted)}
