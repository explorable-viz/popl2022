...
$\begin{array}{lll|llll}
   ...
   \\
   % if
   \desugarFwdF{\exIfThenElse{t}{t_1}{t_2}}(s^\dagger)
   &=&
   \exApp{\exLambda{\elimBool{e_1}{e_2}}}{\desugarFwdF{t}(s)}
   &
   s^\dagger &=& \exIfThenElse{s}{s_1}{s_2}
   \\
   &&&
   (e_1, e_2) &=& (\desugarFwdF{t_1}(s_1), \desugarFwdF{t_2}(s_2))
   \\
   % match
   ...
   &
   s^\dagger &=& \annListComp{s}{\qualDeclaration{p}{s'} \concat \vec{q}}{\alpha}
   \\
   &&&
   e &=&
