\begin{figure}[H]
\flushleft\shadebox{$\sigma \clauseBwd{\vec{p}} e$}
\begin{smathpar}
\inferrule*[
   lab={\ruleName{$\clauseBwd{}$-pattern-seq}}
]
{
...
\vspace{5pt}
\flushleft\shadebox{$\sigma \clauseBwd{p} \kappa$}
\begin{smathpar}
\inferrule*[
   lab={\ruleName{$\clauseBwd{}$-eq}}
]
{
   \sigma \mathrel{\eq\clauseBwd{p}} \kappa
}
{
   \sigma \clauseBwd{p} \kappa
}
%
\and
%
