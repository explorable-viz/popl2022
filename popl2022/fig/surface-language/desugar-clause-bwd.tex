...
]
{
   \sigma \eq \elimList{\kappa}{\sigma'}
   \\
   \sigma' \compRel{\singletonElimBwd{p}}{\singletonElimBwd{p'}} \kappa'
}
{
   \sigma
...
]
{
   \sigma \eq \elimList{\kappa}{\sigma'}
   \\
   \sigma' \compRel{\singletonElimBwd{p}}{\singletonElimBwd{o}} \kappa'
}
{
   \sigma
...
{
   \sigma \compRel{\singletonElimBwd{\vec{p}}}{\desugarBwd{s}} s'
}
{
   \sigma
