...
The surface language \OurLanguage{} supports list notation, list comprehensions, list enumerations, first-class primitives and piecewise function definitions, plus matrices and arbitrary recursive data types. The syntax of the surface-language features that differ from core language features is given in \figref{surface-language:syntax}.
