...
\input{fig/surface-language/slicing/desugar}
\input{fig/surface-language/slicing/desugar-bwd}
\input{fig/surface-language/slicing/desugar-list-rest}
\input{fig/surface-language/slicing/desugar-clause}
\input{fig/surface-language/slicing/totalise}
