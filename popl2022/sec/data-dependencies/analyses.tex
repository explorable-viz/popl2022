...
\todo{Introduce Galois connections and relevance to analysis vis-\`a-vis intuitions in \secref{introduction}. Forward ref discussion in \secref{toolkit}. Also improve notationn for environment lookup functions.}
