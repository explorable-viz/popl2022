...
\end{lemma}\todo{MW: It is not very clear what (,) means here. I think it is tuple, but not exactly sure.}
\todo{MW: It is useful to mention earlier on that this is important for Galois connection.}
