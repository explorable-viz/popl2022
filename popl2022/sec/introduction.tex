...
\begin{itemize}
   ...
   \item[--] a second bidirectional dependency analysis, the De Morgan dual of the first, which is also a Galois connection and which can be composed with the first analysis to link outputs to outputs, with an extended example based on matrix convolution  (\secref{de-morgan});
