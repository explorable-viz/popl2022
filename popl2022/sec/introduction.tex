...
\begin{itemize}
   ...
   \item[--] a second bidirectional dependency analysis, the de Morgan dual of the first, which is also a Galois connection and which can be composed with the first analysis to link outputs to outputs, with an extended example based on matrix convolution  (\secref{toolkit});
