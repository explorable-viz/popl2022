...
\begin{itemize}[leftmargin=*]
   ...
   \item[--] an evaluation of how the core analysis can be used to enrich visualisations with interactions which allow a user to explore their relationship to data and to each other, and a comparison with \emph{Galois slicing}, a program slicing framework with similar round-tripping properties (\secref{toolkit});
