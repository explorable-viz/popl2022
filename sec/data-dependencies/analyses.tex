...
\begin{smathpar}
   \inferrule*[left={\ruleName{$\matchFwdS$-cons}}]
   {
      ...
      {
         \annInt{\kw{5}}{\alpha}, \elimVar{\kw{x}}{\elimVar{\kw{xs}}{e_2}}
         \matchFwdF{\kw{x}}
         \bind{\kw{x}}{\kw{5}}, \elimVar{\kw{xs}}{e_2}, \top
      }
      \\
      \inferrule*[left={\ruleName{$\matchFwdS$-hole-$v$}}]
      {
         ...
         {
            \annCons{\hole}{\hole}{\bot}, \elimVar{\kw{xs}}{e_2}
            \matchFwdF{\kw{xs}}
            \bind{\kw{xs}}{(\exCons{\kw{6}}{\exNil})}, e_2, \top
         }
      }
      {
         \exCons{\kw{6}}{\exNil}, \elimVar{\kw{xs}}{e_2}
         \matchFwdF{\kw{xs}}
         \bind{\kw{xs}}{(\exCons{\kw{6}}{\exNil})}, e_2, \top
      }
   }
   {
         \annCons{\annInt{\kw{5}}{\alpha}}{\hole}{\beta}, \elimList{e_1}{\elimVar{\kw{x}}{\elimVar{\kw{xs}}{e_2}}}
         \matchFwdF{\matchCons{\kw{x}}{\kw{xs}}}
         (\bind{\kw{x}}{\kw{5}}) \concat (\bind{\kw{xs}}{\kw{6}}), e_2
   }
\end{smathpar}

\noindent There will be exactly one non-hole rule that applies as a result of this hole expansion, corresponding to the execution path originally taken, and although there may be multiple such expansions, the following property implies that the result of $\matchFwdF{w}$ will be unique up to $\eq$.
