...
\noindent Proofs and other supplementary material can be found in the extended paper, at \url{https://arxiv.org/abs/2109.00445}. We now introduce the core calculus which provides the setting for the rest of the paper, and which will serve as the desugaring target for the surface syntax presented in \secref{surface-language}.
