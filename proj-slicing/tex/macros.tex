...
\newcommand*{\matchCons}[4]{\{\branchNil{#1},\,\matchPlug{\exCons{#2}{#3}\mapsto\;}{#4}\}}
\newcommand*{\matchConsLow}[4]{\lowlight{\{\branchNil{#1},\,}\matchPlugLow{\exCons{#2}{#3}\mapsto\;}{#4}\lowlight{\}}}
\newcommand*{\matchFalse}[2]{\{\exTrue\mapsto{#1},\,\matchPlug{\exFalse\mapsto}{#2}\}}
\newcommand*{\matchFalseLow}[2]{\lowlight{\{\exTrue\mapsto{#1},\,}\matchPlugLow{\exFalse\mapsto}{#2}\lowlight{\}}}
\newcommand*{\matchHole}[1]{[#1]}
\newcommand*{\matchNil}[4]{\{\matchPlug{\exNil\mapsto}{#1},\branchCons{#2}{#3}{#4}\}}
\newcommand*{\matchNilLow}[4]{\lowlight{\{}\matchPlugLow{\exNil\mapsto}{#1}\lowlight{,\branchCons{#2}{#3}{#4}\}}}
\newcommand*{\matchSum}[2]{[\exInl{#1}, \exInr{#2}]}
\newcommand*{\matchSumL}[1]{[\exInl{#1}]}
\newcommand*{\matchSumR}[1]{[\exInr{#1}]}
\newcommand*{\matchTrue}[2]{\{\matchPlug{\exTrue\mapsto}{#1},\exFalse\mapsto{#2}\}}
\newcommand*{\matchTrueLow}[2]{\lowlight{\{}\matchPlugLow{\exTrue\mapsto}{#1}\lowlight{,\exFalse\mapsto{#2}\}}}
...
\newcommand*{\exConsProjL}[2]{\del{\kw{Cons}(}#1\del{,#2)}}
\newcommand*{\exConsProjR}[2]{\del{\kw{Cons}(#1,}\,#2\del{)}}
...
\newcommand*{\exLetProj}[3]{\del{\kw{let}\;{#1}={#2}\;\kw{in}}\;{#3}}
