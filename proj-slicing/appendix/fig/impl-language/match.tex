...
\begin{smathpar}
   ...
   {
      u, \sigma \match \rho_1, \matchProdLow{\xi}{\tau}
      \\
      v, \tau \match, \rho_2, \matchProdLow{\xi'}{\kappa}
   }
   {
      \exPair{u}{v}, \elimProd{\sigma}
      \match
      \rho_1 \concat \rho_2, \matchProdLow{\xi}{\matchProdLow{\xi'}{\kappa}}
   }
   %
   \and
   %
   ...
   }
   {
      ...
      \match
      \rho_1 \concat \rho_2,
      \matchConsNewLow{\matchProdLow{\xi}{\matchProdLow{\xi'}{\kappa'}}}
   }
\end{smathpar}
