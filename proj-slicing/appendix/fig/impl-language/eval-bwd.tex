...
\begin{smathpar}
   ...
   {
      v, U \bwdSlice \envExtend{(\rho \concat \rho')}{f}{\exClosureRec{\rho^\twoPrime}{f}{\sigma}}, e, \alpha
      \\
      \rho', e, \alpha, \xi, \matchBwd v', \sigma'
      \\
      v', T' \bwdSlice \rho_1, e', \alpha'
      \\
      \exClosureRec{\rho \join \rho^\twoPrime}{f}{(\sigma \join \sigma')}, T
      \bwdSlice
      \rho_2, e^\twoPrime, \alpha^\twoPrime
   }
   {
      v, \trApp{T}{T'}{\matchPlug{\xi}{U}} \bwdSlice \rho_1 \join \rho_2, \exApp{e^\twoPrime}{e'}, \alpha' \join \alpha^\twoPrime
   }
   %
   \and
   %
