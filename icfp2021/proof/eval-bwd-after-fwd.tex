\subsection{\thmref{core-language:pattern-matching:gc}, part (ii)}
...
\begin{flalign}
   ...
   \begin{smathpar}
      ...
      {
         \matchBwd{\rho_2}{\kappa}{\alpha \meet \beta \meet \beta'}{w_2}{v_2}{\sigma}
         \\
         \matchBwd{\rho_1}{\sigma}{\alpha \meet \beta \meet \beta'}{w_1}{v_1}{\tau}
      }
      {
         \matchBwd{\rho_1 \concat \rho_2}
                  {\kappa}
                  {\alpha \meet \beta \meet \beta'}
                  {\matchConsNew{w_1}{w_2}}{\annCons{v_1}{v_2}{\alpha}}{\elimList{\hole}{\tau}}
      }
   \end{smathpar}
   }
   &
