...
\begin{flalign}
   ...
   \\
   &
   \evalFwdGeq{\rho'}{e_1}{\alpha'}{T}{\exClosureRec{\Gamma}{\rho_1 \join \rho_1'}{h}{\sigma}}
   &
   \text{IH}
   \notag
   \\
   &
   \evalFwdEq{\rho \join \rho'}{e_1}{\alpha \join \alpha'}{T}{\exClosureRec{\Gamma}{\rho_1^\dagger}{h'}{\sigma'}}
   \text{ with }
   ...
   \begin{smathpar}
     ...
     {
        \evalFwdEq{\rho \join \rho'}{e_1}{\alpha \join \alpha'}{T}{\exClosureRec{\Gamma}{\rho^\dagger}{h'}{\sigma'}}
        \\
        \rho^\dagger, h' \closeDefs \rho_2'
        \\
        \evalFwd{\rho \join \rho'}{e_2}{\alpha \join \alpha'}{U}{u}
        \\
        u, w, \sigma \matchFwdS \rho_3', e', \beta
        \\
        \evalFwd{\rho_1' \concat \rho_2' \concat \rho_3'}{e'}{\beta}{T'}{u'}
     }
     {
