...
\begin{flalign}
   ...
   \begin{smathpar}
      ...
      {
         \evalFwd{\rho \join \rho'}{e_1}{\alpha \join \alpha'}{T}{\exPrimOp{\phi}{\vec{v}}}
         \\
   ...
   &
   \text{\defrefShort{core-language:primop-gc}; monotonicity}
   \notag
   \\
   \intertext{\crossrule}
   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   \\
   &
   \evalFwdEq{(\rho \join \rho') \concat \rho_1}
             {e}
             {\alpha}
             {T}
             {u}
   ...
   \begin{smathpar}
      ...
      {
         \rho \join \rho', h' \closeDefsFwdR \rho_1
         \\
         \evalFwd{(\rho \join \rho') \concat \rho_1}{e}{\alpha}{T}{v}
      }
      {
         \evalFwd{\rho \join \rho'}{\exLetRecMutual{h'}{e}}{\alpha}{\trLetRecMutual{h}{T}}{v}
      }
   \end{smathpar}
   }
   &
