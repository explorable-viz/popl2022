...
\newcommand*{\comma}{\mathrel{\textbf{\kw{,}}}\;}
\newcommand*{\equal}{\mathrel{\textbf{\kw{=}}}}
\newcommand*{\zipWith}[3]{\kw{zipWith}\;\;{#1}\;\;{#2}\;\;{#3}}
...
\newcommand*{\elim}[1]{\mathsf{elim}({#1})}
\newcommand*{\elimRest}[2]{\mathsf{elimRest}({#1}, {#2})}
\newcommand*{\unelim}[2]{\mathsf{unelim}({#1}, {#2})}
\newcommand*{\merge}[1]{\mathsf{merge}\;{#1}}
\newcommand*{\unmerge}[2]{\mathsf{unmerge}({#1}, {#2})}
\newcommand*{\conts}[1]{\mathsf{conts}\;{#1}}