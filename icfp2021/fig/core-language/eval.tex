...
\begin{smathpar}
   ...
   {
      \explVal{\trMatrix{U_{i,j}}{x}{y}{i}{j}{T}{i',j'}}
              {\rho, \exMatrix{e}{x}{y}{e'} \eval \exMatrix{v_{i,j}}{i}{j}{\exPair{i'}{j'}}}
   }
   %
   \and
   %
   ...
   {
      \explVal{T}{\rho, e \eval \exMatrix{i}{j}{v_{i,j}}{\exPair{i'}{j'}}}
      \\
      \explVal{U}{\rho, e' \eval \exPair{i}{j}}
   }
   {
      \explVal{\trMatrixAccess{T}{i',j'}{U}{i,j}}{\rho, \exMatrixAccess{e}{e'} \eval v_{i,j}}
   }
   %
   \and
   %
   ...
   {
      \explVal{\trMatrixDims{T}{i',j'}}{\rho, \exMatrixDims{e} \eval \exPair{i'}{j'}}
   }
   %
   \and
   %
   ...
   {
      \explVal{T}{\rho, e \eval \exClosureRec{\Gamma}{\rho'}{f}{\sigma}}
      \\
      \explVal{U}{\rho, e' \eval v}
      \\
      ...
      \\
      \explVal{T'}
              {\envExtend{(\rho' \concat \rho^\twoPrime)}{f}{\exClosureRec{\Gamma}{\rho'}{f}{\sigma}},
               e^\twoPrime
               \eval v'}
   }
   {
...
%   }
   ...
   {
      \explVal{T}{\envExtend{\rho}{f}{\exClosureRec{\Gamma}{\rho}{f}{\sigma}}, e \eval v}
   }
   {
