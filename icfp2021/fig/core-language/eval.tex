...
\begin{smathpar}
   ...
   {
      \explVal{\trMatrix{U_{i,j}}{x}{y}{i}{j}{T}}
   ...
   {
      \explVal{\trMatrixAccessNew{T}{i',j'}{U}}{\rho, \exMatrixAccess{e}{e'} \eval v_{i,j}}
   }
   %
   \and
   %
   \inferrule*[lab={\ruleName{$\eval$-matrix-dimensions}}]
   {
      \explVal{T}{\rho, e \eval \exMatrix{\exPair{i'}{j'}}{i}{j}{v_{i,j}}}
   }
   {
      \explVal{\trMatrixSize{T}}{\rho, \exMatrixSize{e} \eval \exPair{i'}{j'}}
   }
   %
   \and
   %
