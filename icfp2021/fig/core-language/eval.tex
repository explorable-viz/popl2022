...
\begin{smathpar}
   ...
   {
      \explVal{T}{\rho, e \eval \exClosureRecNew{\Gamma}{\rho'}{f}{\sigma}}
      \\
      \explVal{U}{\rho, e' \eval v}
      \\
      ...
      \\
      \explVal{T'}
              {\envExtend{(\rho' \concat \rho^\twoPrime)}{f}{\exClosureRecNew{\Gamma}{\rho'}{f}{\sigma}},
               e^\twoPrime
               \eval v'}
   }
   {
   ...
   {
      \explVal{T}{\envExtend{\rho}{f}{\exClosureRecNew{\Gamma}{\rho}{f}{\sigma}}, e \eval v}
   }
   {
