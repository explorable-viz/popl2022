...
\begin{smathpar}
   ...
   {
      \annNil{\alpha}, \matchNilNew, \elimListNew{\kappa}{\sigma}
      \matchFwd
      \envEmpty, \kappa, \alpha
   }
   %
   ...
   {
      \annCons{v}{v'}{\alpha}, \matchConsNew{w}{w'}, \elimListNew{\kappa}{\sigma}
      \matchFwd
      \rho_1 \concat \rho_2, \kappa, \alpha \meet \beta \meet \beta'
   }
\end{smathpar}
...
\begin{salign}
   ...
   \\
   \matchNilNew &\matchFwdHole \elimListNew{\hole}{\hole}
   \\
   \matchConsNew{w}{w'} &\matchFwdHole \elimListNew{\hole}{\hole}
\end{salign}
\end{minipage}
