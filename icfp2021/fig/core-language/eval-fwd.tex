...
\begin{smathpar}
   ...
   {
      \rho, \asExpr{T}, \alpha, T \fwdSlice v
   }
   {
   ...
   {
      \rho, \annMatrix{e'}{x}{y}{e}{\alpha}, \alpha', \trMatrixNew{U_{i,j}}{x}{y}{i}{j}{T}{i',j'}
      \fwdSlice
      \annMatrix{\exPair{i'}{j'}}{i}{j}{v_{i,j}}{\alpha \meet \alpha' \meet \gamma \meet \gamma'}
   }
   %
   \and
   %
   ...
   {
      \rho, e, \alpha, T \fwdSlice \annMatrix{\exPair{i'}{j'}}{i}{j}{v_{i,j}}{\beta}
      \\
      \rho, e', \alpha, U \fwdSlice \annPair{\annInt{i}{\gamma}}{\annInt{j}{\gamma'}}{\beta'}
   }
   {
      \rho, \exMatrixAccess{e}{e'}, \alpha, \trMatrixAccessNew{T}{i',j'}{U}{i,j}
      \fwdSlice
      v_{i,j}
   }
   %
   ...
   {
      \rho, \exMatrixDims{e}, \alpha, \trMatrixDimsNew{T}{i',j'}
      \fwdSlice
   ...
   {
      \rho, \exApp{e}{e'}, \alpha, \trAppPrimNew{T}{\phi}{U}{\exInt{n}}
      \fwdSlice
      \annot{\phi(n)}{\beta}
   }
   %
   ...
   {
      \rho, \exBinaryApp{e}{\primOp}{e'}, \alpha, \trBinaryAppNew{T}{n}{\primOp}{\phi}{U}{m}
      \fwdSlice
