...
\begin{smathpar}
   ...
   \inferrule*[lab={\ruleName{$\fwdSlice$-matrix}}]
   {
      ...
      \\
      \rho, e_2, \alpha', T \fwdSlice v
      \\
      v \geq \annPair{\annInt{\ihat}{\smash{\gamma}}}{\annInt{\jhat}{\smash{\gamma'}}}{}
      \\
      \rho \concat \bind{x}{i_{\gamma}} \concat \bind{y}{j_{\gamma'}}, e_1, \alpha', U_{i,j} \fwdSlice v'_{i,j}
      \quad
      (\forall (i,j) \numleq (\ihat,\jhat))
   }
   {
      ...
      \fwdSlice
      \annMatrix{v'_{i,j}}{i}{j}{v}{\alpha \meet \alpha'}
   }
   %
   \and
   %
   ...
   ]
   {
      ...
      \\
      \rho, e_1, \alpha, T \fwdSlice\geq \annMatrix{v_{i,j}}{i}{j}{v'}{}
   }
   {
   ...
   \inferrule*[lab={\ruleName{$\fwdSlice$-matrix-dims}}]
   {
      ...
      \\
      \rho, e', \alpha', T \fwdSlice\geq \annot{\exMatrix{v_{i,j}}{i}{j}{v}}{}
   }
   {
   ...
   ]
   {
      ...
      \\
      \rho_1 \concat \rho_2, e', \alpha, T \fwdSlice v
   }
   {
