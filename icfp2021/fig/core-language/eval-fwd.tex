...
\begin{smathpar}
   ...
   {
      \rho, \annot{(\exMatrixSize{e})}{\alpha}, \alpha', \trMatrixSize{T}
      \fwdSlice
   ...
   {
      \rho, e, \alpha', T \fwdSlice \annot{\phi}{\beta}
      \\
      \rho, e', \alpha', U \fwdSlice \annot{m}{\beta'}
   }
   {
      \rho, \annot{(\exApp{e}{e'})}{\alpha}, \alpha', \trAppPrim{T}{U}
      \fwdSlice
      \annot{\phi(m)}{\alpha \meet \beta \meet \beta'}
   }
   %
   \and
   %
   ...
   {
      \rho, e, \alpha', T \fwdSlice \annot{\exInt{m}}{\beta}
      \\
      \rho, e', \alpha', U \fwdSlice \annot{\exInt{n}}{\beta'}
   }
   {
      \rho, \annot{(\exBinaryApp{e}{\primOp}{e'})}{\alpha}, \alpha', \trBinaryApp{T}{\primOp}{\phi}{U}
      \fwdSlice
   ...
   {
      \rho, \annot{(\exLet{x}{e}{e'})}{\alpha}, \alpha', \trLet{x}{T}{U} \fwdSlice v'
   }
   %
   \and
   %
   ...
   {
      \envExtend{\rho}{f}{\annot{\exClosureRec{\rho}{f}{\sigma}}{\alpha'}}, e, \alpha', T \fwdSlice v
   }
   {
      \rho, \annot{(\exLetRec{f}{\sigma}{e})}{\alpha}, \alpha', \trLetRec{f}{\sigma}{T} \fwdSlice v
   }
\end{smathpar}
