...
\begin{smathpar}
   ...
   \inferrule*[lab={\ruleName{$\fwdSlice$-matrix}}]
   {
      ...
      \\
      v \geq \annPair{\annInt{\ihat}{\smash{\gamma}}}{\annInt{\jhat}{\smash{\gamma'}}}{\beta}
      \\
   ...
   }
   {
      ...
      \fwdSlice
      \annMatrix{v_{i,j}}{i}{j}{v}{\alpha \meet \alpha'}
   }
   %
   \and
   %
   ...
   ]
   {
      ...
      \\
      \rho, e_1, \alpha, T \fwdSlice\geq \annMatrix{v_{i,j}}{i}{j}{\annPair{\ihat}{\jhat}{}}{}
      \\
      \rho, e_2, \alpha, U \fwdSlice\geq \annPair{i}{j}{}
   }
   {
   ...
   \inferrule*[lab={\ruleName{$\fwdSlice$-matrix-dims}}]
   {
      ...
      \\
      \rho, e', \alpha', T \fwdSlice \annot{\exMatrix{v_{i,j}}{i}{j}{v}}{\beta}
   }
   {
