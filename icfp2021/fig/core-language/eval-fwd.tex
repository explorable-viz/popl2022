...
\begin{smathpar}
   ...
   {
      \rho, \annMatrix{e}{x}{y}{e'}{\alpha}, \alpha', \trMatrix{U_{i,j}}{x}{y}{i}{j}{T}{i',j'}
      \fwdSlice
   ...
   \inferrule*[
      ...
      right={$u = \exClosureRecNew{\Gamma}{\rho'}{f}{\sigma}$}
   ]
   {
   ...
   {
      \envExtend{\rho}{f}{\exClosureRecNew{\Gamma}{\rho}{f}{\sigma}}, e, \alpha, T \fwdSlice v
   }
   {
