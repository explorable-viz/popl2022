...
\begin{smathpar}
   ...
   {
      \rho, e, \alpha, \trOp{\primOp} \fwdSlice \phi
   }
   %
   \and
   %
   ...
   {
      \rho, e, \alpha', \trNil \fwdSlice \annNil{\alpha \meet \alpha'}
   }
   %
   \and
   %
   ...
   {
      \rho, e, \alpha', \trInt{n} \fwdSlice \annInt{n}{\alpha \meet \alpha'}
   }
   %
   \and
   %
   ...
   {
      \rho, e, \alpha, T \fwdSlice \annMatrix{v_{i,j}}{i}{j}{\exPair{i'}{j'}}{\beta}
      \\
   ...
   \inferrule*[
      ...
      right={$u = \exClosureRec{\Gamma}{\rho'}{f}{\sigma}$}
   ]
   {
