...
\begin{smathpar}
   ...
   {
      v \geq \annMatrix{u_{i,j}}{i}{j}{v'}{\beta}
      \\
      u_{i,j}, U_{i,j}
      \bwdSlice
      ...
      \\
      v' \join \annot{\exPair{\annInt{\ihat}{\join{\gamma}}}{\annInt{\jhat}{\join{\gamma'}}}}{\FF}, T \bwdSlice \rho', e', \alpha'
   }
   {
      v,
      ...
      \bwdSlice
      (\join\rho) \join \rho',
      \annMatrix{\join e}{x}{y}{e'}{\beta},
      \beta \join (\join{\alpha}) \join \alpha'
   }
   %
   \and
   %
