...
\begin{smathpar}
   ...
   ]
   {
      ...
      \\
      \forall (i,j) \leq (i',j').
      v_{i,j}, U_{i,j} \bwdSlice \envExtend{\envExtend{\rho'}{x}{i_{\beta_{i,j}}}}{y}{j_{\beta'_{i,j}}}, e', \beta'
   }
   {
      \annot{\exMatrix{\exPair{i'}{j'}}{i}{j}{v_{i,j}}}{\alpha},
      \trMatrix{U_{i,j}}{x}{y}{i}{j}{T}
      \bwdSlice
      \rho \join \rho', \annot{\exMatrix{e}{x}{y}{e'}}{\alpha \join \beta^{\twoPrime}}, \alpha \join \beta \join \beta'
   }
   %
   \and
   %
