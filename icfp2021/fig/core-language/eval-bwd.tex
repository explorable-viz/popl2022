...
\begin{smathpar}
   ...
   }
   {
      ...
      \trMatrixNew{U_{i,j}}{x}{y}{i}{j}{T}{i',j'}
      \bwdSlice
   ...
   {
       v, \trMatrixAccessNew{T}{i',j'}{U}{i,j}
       \bwdSlice
   ...
   {
      \annot{\exPair{\annInt{i'}{\beta}}{\annInt{j'}{\beta'}}}{\alpha}, \trMatrixDimsNew{T}{i',j'}
      \bwdSlice
   ...
   {
      \annInt{n}{\beta}, \trAppPrimNew{T}{\phi}{U}{\exInt{m}}
      \bwdSlice
      \rho \join \rho', \exApp{e}{e'}, \alpha \join \alpha'
   }
   %
   ...
   {
      \annInt{n}{\beta}, \trBinaryAppNew{T}{n'}{\primOp}{\phi}{U}{m}
      \bwdSlice
