...
\begin{smathpar}
   ...
   \inferrule*[
      ...
      right={$v' \geq \annMatrixNew{v_{i,j}}{i}{j}{\exPair{i'}{j'}}{\beta}$}
   ]
   {
      \forall (i,j) \leq (i',j').
      v_{i,j}, U_{i,j}
   ...
   }
   {
      ...
      \annMatrixNew{\Bigjoin{e}}{x}{y}{e'}{\beta},
   ...
   {
      \annMatrixNew{\hole}{i}{j}{\exPair{i'}{j'}}{\FF} \reloverrideleft \{\exPair{i}{j} \mapsto v\}, T
      \bwdSlice
      \rho, e, \alpha
      \\
   ...
   {
      \annMatrixNew{\hole}{i}{j}{\exPair{i'}{j'}}{\beta \join \beta'}, T \bwdSlice \rho, e, \alpha'
   }
   {
      v, \trMatrixDims{T}{i',j'}
      \bwdSlice
