...
\begin{smathpar}
   ...
   ]
   {
      v \geq \annInt{n}{\beta}
      \\
      \evalBwd{\annInt{m}{\beta}}{T}{\rho_1}{e_1}{\alpha}
      \\
      \envLookupBwd{\rho_3}{\Gamma}{\bind{\primOp}{\phi}}
      \\
      \evalBwd{\annInt{m'}{\beta}}{U}{\rho_2}{e_2}{\alpha'}
   }
   {
      \evalBwd{v}
              {\trBinaryApp{T}{m}{\primOp}{\phi}{U}{m'}}
              {\rho_1 \join \rho_2 \join \rho_3}
              {\exBinaryApp{e_1}{\primOp}{e_2}}
              {\alpha \join \alpha'}
   }
   %
   \and
