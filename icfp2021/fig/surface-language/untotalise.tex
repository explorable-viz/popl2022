...
\begin{salign}
   ...
   \\
   \untotalise{\exTrue}{\{\exTrue \mapsto \kappa, \exFalse \mapsto \kappa'\}} &= \kappa
   \\
   \untotalise{\exFalse}{\{\exTrue \mapsto \kappa, \exFalse \mapsto \kappa'\}} &= \kappa'
   \\
   ...
   \\
   \untotalise{\lbrack p \ o}{\{\exNil \mapsto \kappa, \kw{(:)} \ \{s \mapsto s' \mapsto \kappa'\}\}} &= \kappa'
\end{salign}
