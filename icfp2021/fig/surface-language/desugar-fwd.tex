...
{
  \annot{\exListComp{s}{q \comma \exTrue}}{\alpha} \dfwdarrow \annot{e}{\alpha}
}
{
...
{
   \annot{\exIfThenElse{s'}{\exListComp{s}{\vec{q}}}{\exNil}}{\alpha}
   \dfwdarrow e
}
{
   \annot{\exListComp{s}{s' \comma \vec{q}}}{\alpha}
...
{
   \annot{\exListComp{s}{\qualDeclaration{p}{s'} \comma \vec{q}}}{\alpha}
   \dfwdarrow
   \annot{(\exLambda{\sigma} \ e')}{\alpha}
}
\and
...
{
   \annot{\exListComp{s}{\qualGenerator{p}{s'} \comma \vec{q}}}{\alpha}
   \dfwdarrow
