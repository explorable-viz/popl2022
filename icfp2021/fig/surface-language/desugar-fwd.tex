...
}
{
   ...
   \dfwdarrow
   \annot{(\exCons{e}{\annot{\exNil}{{\bigwedge}\alpha}})}{{\bigwedge}\alpha}
}
\and
%
...
}
{
   ...
   \dfwdarrow
   \annot{(\exApp{\annot{(\exLambda{\sigma})}{{\bigwedge}\alpha}}{e'})}{{\bigwedge}\alpha}
}
\and
%
\inferrule*[
...
}
{
   ...
   \dfwdarrow
   \annot{(\exApp{\annot{(\exApp{\annot{\kw{concatMap}}{{\bigwedge}\alpha}}
                                {\annot{(\exLambda{\sigma'})}{{\bigwedge}\alpha}})}
                        {{\bigwedge}\alpha}}{e})}
         {{\bigwedge}\alpha}
}
\end{smathpar}
