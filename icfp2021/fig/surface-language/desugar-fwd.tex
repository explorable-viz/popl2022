...
{
   \annot{(\exIfThenElse{s'}{\annot{\exListComp{s}{\vec{q}}}{\alpha_2}}{\annot{\exNil}{\alpha_1 \meet \alpha_2}})}{\alpha_2}
   \dfwdarrow e
}
{
   \annot{\exListComp{s}{\annot{(\qualGuard{s'})}{\alpha_1} \ \comma \vec{q}}}{\alpha_2}
   \dfwdarrow e
}
\and
%
