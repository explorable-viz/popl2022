...
}
{
   ...
   \dfwdarrow
   \annot{(\exApp{\annot{(\exApp{\kw{enumFromTo}}{e})}{\alpha}}{e'})}{\alpha}
}
%
\and
%
...
}
{
   ...
   \dfwdarrow
   \annot{(\exCons{e}{\annot{\exNil}{\alpha_1 \meet \alpha_2 \meet \alpha_3}})}{\alpha_1 \meet \alpha_2 \meet \alpha_3}
}
\and
%
...
\inferrule*[
   ...
   right={\textnormal{$\vec{q}$ non-empty}}
]
{
...
}
{
   ...
   \dfwdarrow
   \annot{(\exApp{\annot{(\exLambda{\sigma})}{\alpha_1 \meet \alpha_2}}{e'})}{\alpha_1 \meet \alpha_2}
}
\and
%
\inferrule*[
...
}
{
   ...
   \dfwdarrow
   \annot{(\annot{(\exApp{\kw{concatMap}}{\annot{(\exLambda{\sigma'})}{\alpha_1 \meet \alpha_2}})}{\alpha_1 \meet \alpha_2} \ e)}{\alpha_1 \meet \alpha_2}
}
\end{smathpar}
