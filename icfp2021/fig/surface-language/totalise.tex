...
\begin{salign}
   ...
   \\
   \totalise{\pattNil}{\kappa} &= \elimList{\branchNil{\kappa}}{\branchCons{x \mapsto xs \mapsto \exNil}}
   \\
...
\begin{salign}
   \totaliseRest{\pattSNil}{\kappa} &= \elimList{\branchNil{\kappa}}{\branchCons{x \mapsto xs \mapsto \exNil}}
   \\
