\abstract{
   ...
   hoc, limiting their application to certain predefined views or particular
   visual attributes, such as the appearance of points in a scatterplot.
   ...
   second view. We give two examples of the kind of view coordination scenarios
