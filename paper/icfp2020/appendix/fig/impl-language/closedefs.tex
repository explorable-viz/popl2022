...
{
   \rho, \seqEmpty \closeDefs \envEmpty, \sub{\seqEmpty}{\rho}
}
%
\and
%
...
{
   \envEmpty, \sub{\seqEmpty}{\rho} \uncloseDefs \sub{\bot}{\rho}, \seqEmpty
}
%
\and
%
\inferrule*
{
   ...
   \\
   \rho_1 \vee \rho_1', z \uncloseDefs \rho^\dagger, d
}
{
   \rho_1 \concat \rho_2, z \concat \vec{z}
   \uncloseDefs
...
\begin{smathpar}
   ...
   }
   {
      \rho, \exPrimDef{x}
      \closeDefs
      \envExtend{\envEmpty}{x}{\annot{\interpret{x}}{\top}}, \trPrimDef{\sub{x}{\rho}}
   }
\end{smathpar}
