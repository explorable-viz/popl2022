\begin{figure}[p]
\flushleft \shadebox{$\rho, e \eval{} \explVal{T}{u}$}
\begin{smathpar}
   \inferrule*[left={\ruleName{$\eval{}$-annot}}]
   {
      \rho, r
      \eval{}
      \explVal{T}{\annot{v}{\alpha'}}
   }
   {
      \rho,
      \annot{r}{\alpha}
      \eval{}
      \explVal{T}{\annot{v}{\alpha \wedge \alpha'}}
   }
\end{smathpar}
\\
\flushleft \shadebox{$\rho, r \eval{} \explVal{T}{u}$}
\begin{smathpar}
   \inferrule*[
   ...
   {
      \rho, \exVar{x} \eval{} \explVal{\trVarTwo{x}{\rho}}{u}
   }
   %
   \and
   %
   ...
   }
   {
      ...
      \exConst{c}
      \eval{}
      \explVal{\sub{\trEmpty}{\rho}}{\exConst{c}}
   }
   %
   \and
   %
   ...
   }
   {
      ...
      \exFun{\sigma}
      \eval{}
      \explVal{\sub{\trEmpty}{\rho}}{\exClosureNew{\rho}{\seqEmpty}{\exFun{\sigma}}}
   }
   %
   \and
   %
   ...
   {
      \rho, e \eval{} \explVal{T}{\annot{\exClosureNew{\rho_1}{\delta}{\exFun{\sigma}}}{\alpha}}
      \\
      ...
      \eval{}
      \explVal{U}{\annot{v}{\alpha^\twoPrime}}
   }
   {
      \rho,
      \exApp{e}{e'}
   ...
   \inferrule*[
      ...
      right={\textnormal{$c \in \dom{\interpret{\phi}}$}}
   ]
   {
      \rho, e \eval{} \explVal{T}{\annot{\phi}{\alpha}}
      \\
      \rho, e' \eval{} \explVal{T'}{\annot{c}{\alpha'}}
   }
   {
      \rho,
      \exApp{e}{e'}
      \eval{}
      \explVal
         {\trApp{T}{T'}{\matchHole{\sub{\trEmpty}{\envEmpty}}}}
         {\annot{\interpret{\phi}(c)}{\alpha \wedge \alpha'}}
   }
   %
   \and
   %
   \inferrule*[
      ...
      right={\textnormal{$(c, c') \in \dom{\interpret{\primOp}}$
      }}
   ]
   {
      \rho, e \eval{} \explVal{T}{\annot{c}{\alpha'}}
      \\
      \rho, e' \eval{} \explVal{T'}{\annot{c'}{\smash{\alpha^\twoPrime}}}
   }
   {
      \rho,
      ...
      \explVal
         ...
         {\annot{\interpret{\primOp}(c, c')}{\smash{\alpha \wedge \alpha' \wedge \alpha^\twoPrime}}}
   }
   %
   \and
   %
