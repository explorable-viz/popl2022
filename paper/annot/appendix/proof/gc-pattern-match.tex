...
\begin{smathpar}
   ...
   {
      \annot{v}{\alpha}, \elimVar{x}{\annot{\iota}{\alpha'}}
      \lookupR
...
\begin{smathpar}
   ...
   {
     \envExtend{\envEmpty}{x}{\annot{v}{\alpha}}, \annot{\iota}{\alpha'}
     \unlookupR{v^\dagger, \elimVar{x}{\kappa^\dagger}}
     \annot{v}{\alpha}, \elimVar{x}{\annot{\iota}{\alpha'}}
   }
\end{smathpar}
}
...
\begin{smathpar}
   ...
   {
      \annot{\exUnit}{\alpha}, \elimUnit{\annot{\iota}{\alpha'}}
      \lookupR
...
\begin{smathpar}
   ...
   {
     \envEmpty, \annot{\iota}{\alpha \wedge \alpha'}
     \unlookupR{\exUnit, \elimUnit{\kappa^\dagger}}
     \annot{\exUnit}{\alpha \wedge \alpha'}, \elimUnit{\annot{\iota}{\alpha \wedge \alpha'}}
   }
\end{smathpar}
}
&
...
\begin{smathpar}
   ...
   {
      \annot{(\exInl{u})}{\alpha}, \elimSum{\sigma}{\tau} \lookupR \rho, \annot{\iota}{\alpha \wedge \alpha'}
   }
\end{smathpar}
}
&
...
\begin{smathpar}
   ...
   }
   {
     ...
     \unlookupR{\exInl{v^\dagger}, \elimSum{\sigma^\dagger}{\tau^\dagger}}
     \annot{(\exInl{u'})}{\alpha \wedge \alpha'}, \elimSum{\sigma'}{\annot{\tau}{\bot}}
   }
\end{smathpar}
}
&
...
\annot{(\exInl{u'})}{\alpha \wedge \alpha'}, \elimSum{\sigma'}{\annot{\tau}{\bot}}
\leq
\annot{(\exInl{u})}{\alpha}, \elimSum{\sigma}{\tau}
&
\notag
\\
&
...
\begin{smathpar}
   ...
   {
      \annot{(\exInr{u})}{\alpha}, \elimSum{\sigma}{\tau} \lookupR \rho, \annot{\iota}{\alpha \wedge \alpha'}
   }
\end{smathpar}
}
&
...
\begin{smathpar}
   ...
   {
     \rho, \annot{\iota}{\alpha \wedge \alpha'}
     \unlookupR{\exInr{v^\dagger}, \elimSum{\sigma^\dagger}{\tau^\dagger}}
     \annot{(\exInr{u'})}{\alpha \wedge \alpha'}, \elimSum{\annot{\sigma}{\bot}}{\tau'}
   }
\end{smathpar}
}
&
...
\annot{(\exInr{u'})}{\alpha \wedge \alpha'}, \elimSum{\annot{\sigma}{\bot}}{\tau'}
\leq
\annot{(\exInr{u})}{\alpha}, \elimSum{\sigma}{\tau}
&
\notag
\\
&
...
\begin{smathpar}
   ...
   {
      \annot{\exPair{u_1}{u_2}}{\alpha}, \elimProd{\sigma}
      \lookupR
...
\derivation{\derivationWidth}{
   \begin{smathpar}
      ...
      }
      {
        ...
        \unlookupR{\exPair{v_1^\dagger}{v_2^\dagger}, \elimProd{\sigma^\dagger}}
        \annot{\exPair{u_1'}{u_2'}}{\alpha \wedge \alpha' \wedge \alpha^\twoPrime}, \elimProd{\sigma'}
      }
   \end{smathpar}
}
&
...
\begin{smathpar}
   ...
   {
      \annot{(\exRoll{u})}{\alpha}, \elimRoll{\sigma} \lookupR \rho, \annot{\iota}{\alpha \wedge \alpha'}
   }
\end{smathpar}
}
&
...
\begin{smathpar}
   ...
   {
     \rho, \annot{\iota}{\alpha \wedge \alpha'}
     \unlookupR{\exRoll{v^\dagger}, \elimRoll{\sigma^\dagger}}
     \annot{(\exRoll{u'})}{\alpha \wedge \alpha'}, \elimRoll{\sigma'}
   }
\end{smathpar}
}
&
...
\annot{(\exRoll{u'})}{\alpha \wedge \alpha'}, \elimRoll{\sigma'}
\leq
\annot{(\exRoll{u})}{\alpha}, \elimRoll{\sigma'}
&
\notag
\\
...
\begin{smathpar}
   ...
   }
   {
     ...
     \unlookupR{v, \elimVar{x}{\kappa^\dagger}}
     u, \elimVar{x}{\kappa}
   }
\end{smathpar}
}
...
\begin{smathpar}
   ...
   }
   {
     ...
     \unlookupR{\exInl{v^\dagger}, \elimSum{\sigma^\dagger}{\tau^\dagger}}
     \annot{(\exInl{u})}{\alpha}, \elimSum{\sigma}{\annot{\tau}{\bot}}
   }
\end{smathpar}
}
&
...
\begin{smathpar}
   ...
   }
   {
     \rho, \annot{\iota}{\alpha}
     \unlookupR{\exInr{v^\dagger}, \elimSum{\sigma^\dagger}{\tau^\dagger}}
     \annot{(\exInr{u})}{\alpha}, \elimSum{\annot{\sigma}{\bot}}{\tau}
   }
\end{smathpar}
}
&
