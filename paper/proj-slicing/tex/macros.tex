...
\newcommand\grayuline{\bgroup\markoverwith{\textcolor{gray}{\rule[-0.5ex]{2pt}{0.4pt}}}\ULon}

\newcommand*{\del}[1]{\grayuline{\textcolor{gray}{#1}}}
\newcommand*{\delConcat}{\mathbin{\del{\concat}}}

\newcommand*{\tySumProjR}[2]{\del{{#1}\:+}\:{#2}}
\newcommand*{\tySumProjL}[2]{{#1}\:\del{+\:{#2}}}
\newcommand*{\tyProdProjR}[2]{\del{{#1}\:\times}\:{#2}}
\newcommand*{\tyProdProjL}[2]{{#1}\:\del{\times\:{#2}}}
...
\newcommand*{\trieVarProj}[2]{\del{\trieVarNoRHS{#1}\mapsto}\;{#2}}
...
\newcommand*{\trieUnitProj}[1]{\del{\exUnit\mapsto}\;{#1}}
